...
//     let (pattern_coarse, pattern_fine) = crate::core_bpm::bpm_pattern::load_embedded_pattern();
//     let mut analyzer = BpmAnalyzer::new(TARGET_SAMPLE_RATE, None, pattern_coarse, pattern_fine)?;
...
//                         if let Some(result) = analyzer.process(&new_samples_accumulator) {
...
//                 let (pattern_coarse, pattern_fine) =
//                     crate::core_bpm::bpm_pattern::load_embedded_pattern();
//                 match BpmAnalyzer::new(rate, None, pattern_coarse, pattern_fine) {
//                     Ok(new_analyzer) => {
